...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, RoutingListener {
    ...
    public void register(LatLng start,LatLng destino){
        SQLiteOpen conn = new SQLiteOpen(this, "bdMap",null,1);
        ...
        registery.put("latlngstart", String.valueOf(start));
        registery.put("latlngdest", String.valueOf(destino));
        registery.put("date", date);
        Long idResult=database.insert("route",null,registery);
