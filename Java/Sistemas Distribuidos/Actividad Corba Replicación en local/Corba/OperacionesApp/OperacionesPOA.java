...
/**
* OperacionesApp/OperacionesPOA.java .
...
public abstract class OperacionesPOA extends org.omg.PortableServer.Servant
 implements OperacionesApp.OperacionesOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("obtenerInfo", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // OperacionesApp/Operaciones/saludar
       {
         String $result = null;
         $result = this.saludar ();
         out = $rh.createReply();
       ...
       case 1:  // OperacionesApp/Operaciones/obtenerInfo
       {
         String $result = null;
         $result = this.obtenerInfo ();
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 2:  // OperacionesApp/Operaciones/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
